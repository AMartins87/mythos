...
1. log in to [Mythos](https://mythoi.herokuapp.com/)
2. Navbar and a welcome text box will change their links from Login / Register to **Logout**
3. Click on **Logout**
...
2. If users are not logged in, they will be redirected to **Login** page
3. If users logged in, they will be taken to *Share your story* page where they will have to fill in *Title* of the story and the *Story* itself. There is also an option to upload an image which will be saved onto the admin Cloudinary account if users choose to upload their own image to the post.
...
1. If users are not logged in, the like button won't show on the screen, only the number of given likes
...
1. To be able to edit a post, the author has to be logged in to their account
...
3. Once clicked, users will be redirected to **Update post page** where the author can amend the title or the story text

    ![Update post testing 2](media/testing/edit_post_testing_2.png)

4. Once the author clicks the **Update** button, they will be redirected to **Home** page
...
1. To be able to delete a post, the author has to be logged in to their account
...
3. Once clicked, users will be redirected to **Delete post page** where the author will be asked if they are sure they want to delete the post and given a choice of **Delete** button or **Go back** which would take them back to **Home** page
